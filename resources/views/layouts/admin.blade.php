...
<head>
    ...
    <title>@yield('title', 'Admin Panel') - {{ config('app.name', 'SecureHome') }}</title>

    <meta name="description" content="Admin panel for SecureHome security management system" />
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('admin.dashboard') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">SecureHome</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ request()->routeIs('admin.appointments.*') ? 'active open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons fas fa-calendar-check"></i>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item {{ request()->routeIs('admin.appointments.index') ? 'active' : '' }}">
                                <a href="{{ route('admin.appointments.index') }}" class="menu-link">
                                    <div data-i18n="All Appointments">All Appointments</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->routeIs('admin.appointments.create') ? 'active' : '' }}">
                                <a href="{{ route('admin.appointments.create') }}" class="menu-link">
                                    <div data-i18n="Schedule New">Schedule New</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item {{ request()->routeIs('admin.users.*') ? 'active open' : '' }}">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('admin.users.index') }}?role=homeowner" class="menu-link">
                                    <div data-i18n="Homeowners">Homeowners</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('admin.users.index') }}?role=officer" class="menu-link">
                                    <div data-i18n="Officers">Officers</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                ...
                                made with ❤️ by <strong>SecureHome Team</strong>
                            </div>
                            <div>
